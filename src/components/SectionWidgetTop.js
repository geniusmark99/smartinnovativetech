export default function SectionWidgetTop() {
    return <>
    ...
    <div className="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 py-10 lg:py-16">
      <div className="max-w-2xl text-center mx-auto">
        <p className="inline-block text-sm font-medium bg-clip-text bg-gradient-to-l from-blue-600 to-violet-500 text-transparent dark:from-blue-400 dark:to-violet-400">
          100 Billionaire: A vision for 2024
        </p>

        <div className="mt-5 max-w-2xl">
          <h1 className="block font-semibold text-gray-800 text-4xl md:text-5xl lg:text-6xl dark:text-neutral-200">
            With the Right Mentor, you gain speed and excellency
          </h1>
        </div>

        <div className="mt-5 max-w-3xl">
          <p className="text-lg text-gray-600 dark:text-neutral-400">
            With Sabii gal proven trading records, and your dedication to learn, nothing can stand in your way to be a successful trader.
